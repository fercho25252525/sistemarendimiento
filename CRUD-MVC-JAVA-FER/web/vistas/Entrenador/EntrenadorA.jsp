...
<html lang="es"> 
    ...
    <body id="page-top">
        <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
            <a class="navbar-brand mr-1 letraPr" href="../Administrador/Administrador.jsp"><%= " " + rol%></a>
                ...
                <div class="container"> 
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <p id="bienbenidos" style="font-family: initial; text-align: center;font-weight: 600; font-size: 4.8em; line-height: 85px;">BIENVENIDO AL MÓDULO DE RENDIMIENTO DEPORTIVO </p>
                        </div>
                    </div>
                    <br>
                    <center>
                        <div class="form-group " style="margin-top: -60px">
                            <div class="form-row">
                                <div class="col-md-12 ">
                                    <h2 style="text-align: center; color: #57c257; font-family: cursive; font-weight: 600; font-size: 2.6em">Enviar correo</h2>
                                ...
                                <div class="card card-register mx-auto mt-4" style="border: none">
                                    <div class="my-form-top">
                                        <div class="myform-top-left">
                                            <br>
                                            <h3 id="registrarinventarioIIRe" style="font-family: cursive; font-weight: 600; font-size: 2.1em">Enviar correo...</h3>
                                        </div>
                                        <div class="Myform-top-right">
                                        ...
                                        <form id="frm_contact" name="frm_contact"  enctype="multipart/form-data" >
                                            <center>
                                                <div class="form-group">
                                                    <div class="form-row">                                                
                                                        <div class="col-md-12">
                                                            <label class="letra">Para:</label><br>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-row">                                                
                                                        ...
                                                        <div class="col-md-12">
                                                            <label class="letra">Asunto:</label>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-row">  
                                                        <div class="col-md-12">
                                                            <label class="letra">Mensaje</label>
